...
pricing_content = [
    ...
    "            <div className='mt-4'><span className='text-4xl font-bold'>Free forever</span></div>",
    "          </CardHeader>",
    "          <CardContent>",
    ...
    "            <div className='mt-4'><span className='text-4xl font-bold'>19 USD</span><span className='text-muted-foreground ml-2'>/month</span></div>",
    "            <p className='text-sm text-muted-foreground'>Or 190 USD/year (save 17%)</p>",
    "          </CardHeader>",
    "          <CardContent>",
    "            <ul className='space-y-3'>",
    "              {PRO_FEATURES.map((f) => (",
...
w("src/app/(marketing)/pricing/page.tsx", "
